...
import 'dart:convert';
import 'dart:io';
import 'package:covid_safe_app/configuration/AuthSingleton.dart';
...
class BaseClient  {
  ...
  Future<dynamic> get(String baseUrl, String api) async {
    ...
    try {
      var response = await AuthSingleton().CustomHttpClient.get(uri).timeout(Duration(seconds: TIME_OUT_DURATION));
